package Algorithmization.Multi_Array.Task_16;
...
/**
 * Магическим квадратом порядка n называется квадратная матрица размера n x n, составленная из чисел 1, 2, 3, ..., n*n
...
public class Task_16 {
    public static void main(String[] args) {
        ...
        System.out.print("Задайте порядок магического квадрата: ");
        int n = scanner.nextInt();

        while (n < 3) {
            System.out.printf("Магический квадрат порядка %d не существует.%n", n);
            System.out.print("Задайте другой порядок магического квадрата: ");
            n = scanner.nextInt();
        }
        if ((n - 1) % 2 == 0) {
